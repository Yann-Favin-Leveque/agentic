...
import io.github.sashirestela.openai.agent.InstanceConfig;
import io.github.sashirestela.openai.agent.Provider;
...
/**
 * AgentServiceV2 - Refactored agent service with modular architecture.
 *
 ...
 */
public class AgentServiceV2 {

    private static final Logger logger = LoggerFactory.getLogger(AgentServiceV2.class);
    ...
    /**
     * Constructs AgentServiceV2 with the provided configuration.
     */
    public AgentServiceV2(AgentServiceConfig config) {
        this.config = config;
     ...
     * @return Agent
     * @throws io.github.sashirestela.openai.agent.exception.AgentNotFoundException if not found
     */
    ...
    public void shutdown() {
        logger.info("Shutting down AgentServiceV2");
    }
