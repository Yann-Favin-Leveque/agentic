...
/**
 * Unit tests for {@link AgentServiceConfig} configuration builder. These tests verify the
 * JSON-based configuration parsing and validation.
 */
class AgentServiceConfigTest {

    private static final String VALID_INSTANCES_JSON = "[{\"id\":\"openai-main\",\"url\":\"https://api.openai.com\",\"key\":\"sk-xxx\",\"models\":\"gpt-4o,gpt-4o-mini\",\"provider\":\"openai\",\"enabled\":true},"
            +
    ...
    private static final String SINGLE_INSTANCE_JSON = "[{\"id\":\"openai-main\",\"url\":\"https://api.openai.com\",\"key\":\"sk-xxx\",\"models\":\"gpt-4o\",\"provider\":\"openai\",\"enabled\":true}]";
    ...
    void testMultiProviderConfiguration() {
        String multiProviderJson = "[{\"id\":\"openai\",\"url\":\"https://api.openai.com\",\"key\":\"sk-xxx\",\"models\":\"gpt-4o\",\"provider\":\"openai\",\"enabled\":true},"
                +
