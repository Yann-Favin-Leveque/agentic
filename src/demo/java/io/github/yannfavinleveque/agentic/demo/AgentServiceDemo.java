...
/**
 * Demo for AgentService showing the new JSON-based configuration.
 *
 * Prerequisites:
...
public class AgentServiceDemo {
    ...
    public void demoJsonConfiguration() throws IOException {
        ...
        System.out.println("[");
        System.out.println("  {\"id\":\"openai-main\",\"url\":\"https://api.openai.com\",\"key\":\"sk-xxx\",\"models\":\"gpt-4o\",\"provider\":\"openai\",\"enabled\":true},");
        System.out.println("  {\"id\":\"azure-1\",\"url\":\"https://my-resource.openai.azure.com\",\"key\":\"xxx\",\"models\":\"gpt-4o\",\"provider\":\"azure\",\"apiVersion\":\"2024-08-01-preview\",\"enabled\":true},");
        System.out.println("  {\"id\":\"azure-anthropic\",\"url\":\"https://my-resource.services.ai.azure.com\",\"key\":\"xxx\",\"models\":\"claude-sonnet-4-5\",\"provider\":\"azure-anthropic\",\"apiVersion\":\"2023-06-01\",\"enabled\":true}");
        System.out.println("]\n");
    ...
    public void demoChatCompletion() throws IOException {
        ...
        System.out.println("WeatherResult result = service.chatCompletion(\"gpt-4o\", messages, 0.7, WeatherResult.class).join();");
